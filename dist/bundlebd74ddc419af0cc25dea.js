...
function _getWeatherData() {
  _getWeatherData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, data;
...
function populateDom(weatherData) {
  ...
  tempToggle.addEventListener('click', function () {
    return toggleTempScale(tempToggle, temp, weatherData);
  });
}
...
function _changeTown() {
  _changeTown = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(searchField) {
    var weatherData;
...
/******/ })()
;
//# sourceMappingURL=bundlebd74ddc419af0cc25dea.js.map